...
public class DiscordPresence extends Module {
    ...
    public DiscordPresence() {
        super(Categories.Misc, "discord-presence", "Displays Mineciska as your presence on Discord.");
    ...
    public void onActivate() {
        DiscordIPC.start(1499840369377021987L, null);

        rpc.setStart(System.currentTimeMillis() / 1000L);

        String largeText = "%s %s".formatted(MeteorClient.NAME, MeteorClient.VERSION);
        rpc.setLargeImage("mineciska_icon_v1", largeText);
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (Utils.canUpdate()) {
            ...
            if (!lastWasInMainMenu) {
                ...
                else if (mc.currentScreen instanceof WidgetScreen) rpc.setState("Browsing Mineciska's GUI");
